...
<style type="text/css">
 ...
 function preloader() 
 {
     ...
     RelayONImage.src = "img/relay_on.png";
     RelayOFFImage = new Image(); 
     RelayOFFImage.src = "img/relay_off.png";
 }
 </script>
...
<td width="1000" align="center"><div class="cssbox">
    ...
    <td height="38" colspan="2"><table width="850" height="44" border="0">
     <tr>
        <td height="40" valign="top">
          <p><strong>Sensor Information</strong></p>
          <p id="sensorInfo"></p>
        </td>
  ...
  <tr>
    ...
    <applet code="com.charliemouse.cambozola.Viewer"
        archive=java/cambozola.jar width="640" height="480" style="border-width:1;
        border-color:gray; border-style:solid;">
    <param name="url" value="<?php echo $camera_address; ?>">
    </applet>
    </p>
    <p><button onclick="StartCam()">Start Camera</button>
    			<button onclick="RestartCam()">Restart Camera</button>
    		 	<button onclick="StopCam()">Stop Camera</button>
         <script language="javascript" type="text/javascript">
			function StartCam() {
			  window.location.assign("/yieldbuddy/www/command.php?command=start cam&submit=Start Camera")
			}
			function RestartCam() {
			  window.location.assign("/yieldbuddy/www/command.php?command=restart cam&submit=Restart Camera")
			}
			function StopCam() {
			  window.location.assign("/yieldbuddy/www/command.php?command=stop cam&submit=Stop Camera")
			}
         </script>
    </p>
    </td>
