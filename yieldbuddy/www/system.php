...
<p align="center"><span class="description">Filename must be 'firmware.cpp.hex'  Click 'Upload' to upload. Click 'Update' to update.</span></p>
  ...
  <tr>
    ...
    <?php
		...
		$RaspberryPi_hour = $segments[3];
		#echo "    Hour: ";
		#echo $RaspberryPi_hour;
		#echo "    Minute: ";
		$RaspberryPi_min = $segments[4];
		#echo $RaspberryPi_min;
		#echo "    Second: ";
		$RaspberryPi_sec = $segments[5];
		$RaspberryPi_sec = $segments[5];
    ...
    ?>
       <table width="775" border="0" align="center">
        ...
        <form action="command.php" method="get">
          ...
          <td width="655">
		  Month
		  <select name="Rasp_month" id="Rasp_month">
            <?php
       ...
       <table width="705" border="0" align="center">
         <tr>
           <td width="677" align="center"><h5><em>Note: This uses TLS (Transport Layer Security, a protocol that encrypts and delivers mail securely.)</em> &nbsp;Make sure<br />
             your settings match the TLS settings for the server you are connecting to.</h5></td>
         </tr>
     </table>
	...
	<p><button onclick="ClearLog()">Clear Log</button>
         <script language="javascript" type="text/javascript">
	 function ClearLog() {
	 	var sub="Clear Log"
	 	var com="clear log"
	  window.location.assign("/yieldbuddy/www/command.php?command=clear log&submit=Clear Log")
	 }
         </script>
        </p>
  </tr>
