...
include ($_SERVER['DOCUMENT_ROOT'].'/yieldbuddy/www/sql/sql_relays_firstrow.php');
	  ...
	  // echo $Relay1. "<br />";
  	  ...
  	  $Relay1_isAuto = $_SESSION['Relay1_isAuto'];
  		if ($Relay1 == "0") {
	 		echo "<td align=\"center\"><img src=\"img/relay_off.png\" title=\"Relay 1 OFF\" alt=\"Relay 1 OFF\" onclick=\"TurnRelay(1, 'on')\"/></td>";
	    	} elseif ($Relay1 == "1") {
	 		echo "<td align=\"center\"><img src=\"img/relay_on.png\" title=\"Relay 1 ON\" alt=\"Relay 1 ON\" onclick=\"TurnRelay(1, 'off')\"/></td>";
		}
		if ($Relay1_isAuto == "0") {
