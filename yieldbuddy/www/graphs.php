...
<script type="text/javascript">
    ...
    function drawChart() {
      ...
      data.addColumn('number', 'pH2');
       ...
       var chart = new google.visualization.AnnotationChart(document.getElementById('pH_Chart'));
       var options = {
       ...
       function onReady() {
        var x = document.getElementById('pH_Chart_AnnotationChart_zoomControlContainer').getElementsByTagName('button');
        document.getElementById('pH_Chart_AnnotationChart_zoomControlContainer').style.fontSize = '14px';
...
<script type="text/javascript">
    ...
    function drawChart() {
      ...
      data.addColumn('number', 'Temperature');
       ...
       function onReady() {
        var x = document.getElementById('Temperature_Chart_AnnotationChart_zoomControlContainer').getElementsByTagName('button');
        document.getElementById('Temperature_Chart_AnnotationChart_zoomControlContainer').style.fontSize = '14px';
        for (var i = 0; i < x.length; i++) {
          x[i].style.height = '40px';
          x[i].style.width = '40px';
          x[i].style.fontSize = '14px';
...
function drawChart() {
  ...
  data.addColumn('number', 'TDS2');
	...
	?>
       ...
       var chart = new google.visualization.AnnotationChart(document.getElementById('TDS_Chart'));
       ...
       function onReady() {
        var x = document.getElementById('TDS_Chart_AnnotationChart_zoomControlContainer').getElementsByTagName('button');
        document.getElementById('TDS_Chart_AnnotationChart_zoomControlContainer').style.fontSize = '14px';
        for (var i = 0; i < x.length; i++) {
          x[i].style.height = '40px';
          x[i].style.width = '40px';
          x[i].style.fontSize = '14px';
...
function drawChart() {
  ...
  data.addColumn('number', 'Light');
	...
	?>
       ...
       var chart = new google.visualization.AnnotationChart(document.getElementById('Percentage_Chart'));
       var options = {
         displayAnnotations: true
       };
       google.visualization.events.addListener(chart, 'ready', onReady);
       ...
       function onReady() {
        var x = document.getElementById('Percentage_Chart_AnnotationChart_zoomControlContainer').getElementsByTagName('button');
        document.getElementById('Percentage_Chart_AnnotationChart_zoomControlContainer').style.fontSize = '14px';
        for (var i = 0; i < x.length; i++) {
          x[i].style.height = '40px';
          x[i].style.width = '40px';
          x[i].style.fontSize = '14px';
